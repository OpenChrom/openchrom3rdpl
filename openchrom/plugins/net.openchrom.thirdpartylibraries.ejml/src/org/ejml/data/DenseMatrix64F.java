...
public class DenseMatrix64F extends RowD1Matrix64F {
	...
	/**
	 * <p>
	 * Sets the value and shape of this matrix to be identical to the specified matrix. The width and height are changed to match the matrix that has been provided. If more memory is needed then a new data array is declared.<br>
	 * <br>
...
/**
	...
	/**
	 * <p>
	 * Converts the array into a string format for display purposes. The conversion is done using {@link MatrixIO#print(java.io.PrintStream, Matrix64F)}.
	 * </p>
	 * 
