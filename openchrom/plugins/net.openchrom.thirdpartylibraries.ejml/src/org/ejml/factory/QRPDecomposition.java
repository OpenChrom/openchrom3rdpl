...
public interface QRPDecomposition<T extends Matrix64F> extends QRDecomposition<T> {
	...
	/**
	 * <p>
	 * Specifies the threshold used to flag a column as being singular. The optimal threshold (if one exists) varies by the matrix being processed. A reasonable value would be the maximum absolute value of the matrix's elements multiplied by EPS:<br>
